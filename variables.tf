...
variable "parameters" { # This prevents the values from being printed in the CLI
  default = {
    ...
    "dev.roboshop.cart.REDIS_HOST"           = "dev-roboshop-elasticache.kbwgpw.0001.use1.cache.amazonaws.com"
